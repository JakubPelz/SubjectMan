function insert(styleEl) {
  ...
  styleEl.setAttribute("data-owner", "uu_subject_man-hi/uu_subject_man-hi@0.3.3");
  styleEl.setAttribute("data-emotion", "uusubjectman");
  styleEl.setAttribute("data-tech", "less");

  // insert the style element
  // 1. after last matching data-emotion using technology "less"
  let els = insertionEl.querySelectorAll(`style[data-emotion="uusubjectman"]`);
